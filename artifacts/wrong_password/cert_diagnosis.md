...
```json
{
  "cert_dir": "/tmp/pytest-of-root/pytest-2/test_run_certificate_doctor_sc1/certs_local",
  "cert_dir_source": "parameter",
  "default_cert_dir": "/root/.local/share/VertexDTE/certificados",
  "signer_cert_dir": "/tmp/pytest-of-root/pytest-2/test_run_certificate_doctor_sc1/certs_local",
  "nit_config": "09061712791014",
  "nit_crt": "09061712791014",
  "cert_path": "/tmp/pytest-of-root/pytest-2/test_run_certificate_doctor_sc1/certs_local/09061712791014.crt",
  "cert_exists": true,
  "cert_size": 224,
...
```json
{
  ...
  "signer_cert_dir": "/tmp/pytest-of-root/pytest-2/test_run_certificate_doctor_sc1/certs_local",
  "env": {
    "CERT_UPLOAD_DIR": "/tmp/pytest-of-root/pytest-2/test_run_certificate_doctor_sc1/certs_local",
    "FIRMADOR_CERT_DIR": "/tmp/pytest-of-root/pytest-2/test_run_certificate_doctor_sc1/certs_local"
  },
  "files": [
    {
...
```json
{
  ...
  "password_sha512": {
    "local": "eb82bc9ae1613ff7388b9408ef2383a6a43a0cae80af02d8fd796075c493fa601f4ddd02cde2b4b8d587698063c197b00fe6ac454b423fe9572efedb14a1b90f",
    "remote": "eb82bc9ae1613ff7388b9408ef2383a6a43a0cae80af02d8fd796075c493fa601f4ddd02cde2b4b8d587698063c197b00fe6ac454b423fe9572efedb14a1b90f",
    "match": true
  }
}
```
