...
* **OK:** False
* **Problemas detectados:** dir_mismatch
* **Causa probable:** El firmador usa otra carpeta de certificados
* **Remediación sugerida:** Ajusta CERT_UPLOAD_DIR/FIRMADOR_CERT_DIR en el servicio y reinicia el firmador.
...
```json
{
  "cert_dir": "/tmp/pytest-of-root/pytest-2/test_run_certificate_doctor_sc3/certs_local",
  "cert_dir_source": "parameter",
  "default_cert_dir": "/root/.local/share/VertexDTE/certificados",
  "signer_cert_dir": "/tmp/pytest-of-root/pytest-2/test_run_certificate_doctor_sc3/certs_remote",
  "nit_config": "09061712791014",
  "nit_crt": "09061712791014",
  "cert_path": "/tmp/pytest-of-root/pytest-2/test_run_certificate_doctor_sc3/certs_local/09061712791014.crt",
  "cert_exists": true,
  "cert_size": 224,
...
```json
{
  ...
  "signer_cert_dir": "/tmp/pytest-of-root/pytest-2/test_run_certificate_doctor_sc3/certs_remote",
  "env": {
    "CERT_UPLOAD_DIR": "/tmp/pytest-of-root/pytest-2/test_run_certificate_doctor_sc3/certs_remote",
    "FIRMADOR_CERT_DIR": "/tmp/pytest-of-root/pytest-2/test_run_certificate_doctor_sc3/certs_remote"
  },
  "files": [
    {
